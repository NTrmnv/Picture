...
/* harmony import */ var _modules_checkLangInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/checkLangInputs */ "./src/js/modules/checkLangInputs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkLangInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="name"]');
  Object(_modules_checkLangInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="message"]');
...
/***/ "./src/js/modules/checkLangInputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkLangInputs.js ***!
  \*******************************************/
/*! exports provided: default */
...
var checkLangInputs = function checkLangInputs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkLangInputs);
...
var drop = function drop() {
  ...
  function highlight(item) {
    ...
    item.closest('.file_upload').style.backgroungColor = "rgba(0,0,0,0.7)";
  }
  ...
  ['dragenter', 'dragover'].forEach(function (eventName) {
    fileInputs.forEach(function (fileInput) {
      fileInput.addEventListener(eventName, function () {
        return highlight(fileInput);
      }, false);
    });
  });
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  button.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles').then(function (res) {
      ...
      errorMessage.textContent = "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u044F \u043A \u0441\u0435\u0440\u0432\u0435\u0440\u0443: ".concat(Error);
